...
def main():
	...
	exte = False
	try:
		paraDict = Pyth.StriTo__Dict(para)
		exte = True
		direOut = dire + "out_" + os.sep + "tree_" + numb + "_para"
	except:
		paraDict = Pyth.FileTo__Line("tree_para")
	...
	Blen.ModiSkin(inde = 0, scal = True, applModi = True, tranInde = True, appl = True)
	#Blen.ModiSkin(inde = 0, scal = True, applModi = False, tranInde = True, appl = True)
	Blen.MateSet_("bark")
