...
# Cycl()
# PathChec()
def Char(loca = (0.0, 0.0, 0.0), dire = "", empt = 1.0, cyclArms = True, acti = [], coun = 16):
	Blen = BlenLink()
	Math = MathLink()
	logiDire = LogiDireLink()
...
def Over():
	...
	contDict = BlenGame.LogiContDict(typ_ = cont)
	actuDict = BlenGame.LogiActuDict(typ_ = actu)
	sensDict["mouse_event"] = "MOUSEOVER"
	actuDict["property"] = "over"
	actuDict["value"] = "True"
	BlenGame.Logi(sensDict = sensDict, contDict = contDict, actuDict = actuDict)
	sensOpti = BlenGame.LogiSensOpti()
	sensOpti["invert"] = True
	actuDict["value"] = "False"
	BlenGame.Logi(sensDict = sensDict, sensOpti = sensOpti, contDict = contDict, actuDict = actuDict)
