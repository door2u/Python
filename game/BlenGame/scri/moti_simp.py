...
owne = cont.owner
f = scen.objects[owne.name + ".forward"]["path_check"]
l = scen.objects[owne.name + ".left"]["path_check"]
b = scen.objects[owne.name + ".back"]["path_check"]
r = scen.objects[owne.name + ".right"]["path_check"]
