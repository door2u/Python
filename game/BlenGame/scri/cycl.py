...
def main():
	...
	if cycl == 2:
		...
		Cycl(trac = owne.name + ".axle.legs.l", t = t, acti = acti, radi = cyclRadi, spee = cyclSpee, uppe = owne.name + ".hip.l", lowe = owne.name + ".knee.l", end = owne.name + ".foot.l", righ = False, arms = False, armsRati = 0.0, uppeLeng = uppeLeng, loweLeng = loweLeng, faci = faci)
		Cycl(trac = owne.name + ".axle.legs.r", t = t, acti = acti, radi = cyclRadi, spee = cyclSpee, uppe = owne.name + ".hip.r", lowe = owne.name + ".knee.r", end = owne.name + ".foot.r", righ = True,  arms = False, armsRati = 0.0, uppeLeng = uppeLeng, loweLeng = loweLeng)
		...
		if cyclArms == True:
			...
			Cycl(trac = owne.name + ".axle.arms.l", t = t, acti = acti, radi = cyclRadi, spee = cyclSpee, uppe = owne.name + ".shoulder.l", lowe = owne.name + ".elbow.l", end = owne.name + ".hand.l", righ = False, arms = True, armsRati = armsRati, uppeLeng = uppeLeng, loweLeng = loweLeng)
			Cycl(trac = owne.name + ".axle.arms.r", t = t, acti = acti, radi = cyclRadi, spee = cyclSpee, uppe = owne.name + ".shoulder.r", lowe = owne.name + ".elbow.r", end = owne.name + ".hand.r", righ = True,  arms = True, armsRati = armsRati, uppeLeng = uppeLeng, loweLeng = loweLeng)
		osci = owne[acti + "Osci"]
		if osci != 0.0:
	...
	if cycl == 3:
		...
		scen.objects[owne.name + "." + "hip.l"].localOrientation = eule.to_matrix()
		scen.objects[owne.name + "." + "hip.r"].localOrientation = eule.to_matrix()
		...
		scen.objects[owne.name + "." + "shoulder.l"].localOrientation = eule.to_matrix()
		scen.objects[owne.name + "." + "shoulder.r"].localOrientation = eule.to_matrix()
		scen.objects[owne.name + "." + "elbow.l"].localOrientation = eule.to_matrix()
		scen.objects[owne.name + "." + "elbow.r"].localOrientation = eule.to_matrix()
		osci = owne[acti + "Osci"]
		if osci != 0.0:
			owne["z___"] = 0.0
		tilt = owne[acti + "Tilt"]
